...
def main():
    ...
    detail_font[7] = HPDF_GetFont(pdf, "MS-PMincyo,BoldItalic", "90msp-RKSJ-H")
    ...
    detail_font[15] = HPDF_GetFont(pdf, "MS-PGothic,BoldItalic", "90msp-RKSJ-H")
    ...
    for i in range(16):
        ...
        outline = HPDF_CreateOutline(
            pdf, root, HPDF_Font_GetFontName(detail_font[i]), NULL
        )
