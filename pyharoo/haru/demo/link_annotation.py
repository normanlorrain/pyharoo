...
def main():
    ...
    HPDF_Page_ShowText(
        index_page, "Jump to Page1 (HilightMode=HPDF_ANNOT_NO_HIGHTLIGHT)"
    )
    rect.left = tp.x - 4
    rect.bottom = tp.y - 4
    ...
    HPDF_Page_ShowText(
        index_page, "Jump to Page3 (HilightMode=HPDF_ANNOT_INVERT_BORDER)"
    )
    rect.left = tp.x - 4
    rect.bottom = tp.y - 4
    rect.right = HPDF_Page_GetCurrentTextPos(index_page).x + 4
    ...
    HPDF_Page_ShowText(
        index_page, "Jump to Page4 (HilightMode=HPDF_ANNOT_DOWN_APPEARANCE)"
    )
    rect.left = tp.x - 4
    rect.bottom = tp.y - 4
    rect.right = HPDF_Page_GetCurrentTextPos(index_page).x + 4
