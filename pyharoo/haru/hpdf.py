...
def HPDF_ReadFromStream(
    pdf, buf, size,  # HPDF_Doc  # POINTER(HPDF_BYTE)  # POINTER(HPDF_UINT32)
):
...
def HPDF_SetPagesConfiguration(
    pdf, page_per_pages,  # HPDF_Doc  # HPDF_UINT
):
    page_per_pages = HPDF_UINT(int(page_per_pages))
    return _HPDF_SetPagesConfiguration(pdf, page_per_pages,)  # HPDF_Doc  # HPDF_UINT
...
def HPDF_Page_SetWidth(
    page, value,  # HPDF_Page  # HPDF_REAL
):
    value = HPDF_REAL(value)
    return _HPDF_Page_SetWidth(page, value,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_SetHeight(
    ...
    value = HPDF_REAL(value)
    return _HPDF_Page_SetHeight(page, value,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_SetRotate(
    page, angle,  # HPDF_Page  # HPDF_UINT16
):
    angle = HPDF_UINT16(int(angle))
    return _HPDF_Page_SetRotate(page, angle,)  # HPDF_Page  # HPDF_UINT16
...
def HPDF_Destination_SetXYZ(
    dst, left, top, zoom,  # HPDF_Destination  # HPDF_REAL  # HPDF_REAL  # HPDF_REAL
):
    left = HPDF_REAL(left)
    top = HPDF_REAL(top)
    zoom = HPDF_REAL(zoom)
...
def HPDF_Destination_SetFitH(
    dst, top,  # HPDF_Destination  # HPDF_REAL
):
    top = HPDF_REAL(top)
    return _HPDF_Destination_SetFitH(dst, top,)  # HPDF_Destination  # HPDF_REAL
...
def HPDF_Destination_SetFitV(
    dst, left,  # HPDF_Destination  # HPDF_REAL
):
    left = HPDF_REAL(left)
    return _HPDF_Destination_SetFitV(dst, left,)  # HPDF_Destination  # HPDF_REAL
...
def HPDF_Destination_SetFitBH(
    ...
    top = HPDF_REAL(top)
    return _HPDF_Destination_SetFitBH(dst, top,)  # HPDF_Destination  # HPDF_REAL
...
def HPDF_Destination_SetFitBV(
    ...
    left = HPDF_REAL(left)
    return _HPDF_Destination_SetFitBV(dst, left,)  # HPDF_Destination  # HPDF_REAL
...
def HPDF_Encoder_GetByteType(
    encoder, text, index  # HPDF_Encoder  # const char *  # HPDF_UINT
):
...
def HPDF_LoadRawImageFromFile(
    ...
    filename = bytes(
        str(filename), "utf-8"
    )  # filename could be bytes, str, or pathlib.Path.
...
def HPDF_Image_GetSize2(
    image, size=None,  # HPDF_Image  # POINTER(HPDF_Point)
):
    size = HPDF_Point
    ret = _HPDF_Image_GetSize2(image, size,)  # HPDF_Image  # POINTER(HPDF_Point)
...
def HPDF_SetPermission(
    pdf, permission,  # HPDF_Doc  # HPDF_UINT
):
    permission = HPDF_UINT(int(permission))
    return _HPDF_SetPermission(pdf, permission,)  # HPDF_Doc  # HPDF_UINT
...
def HPDF_SetEncryptionMode(
    pdf, mode, key_len,  # HPDF_Doc  # HPDF_EncryptMode  # HPDF_UINT
):
...
def HPDF_ExtGState_SetAlphaStroke(
    ext_gstate, value,  # HPDF_ExtGState  # HPDF_REAL
):
    value = HPDF_REAL(value)
...
def HPDF_Page_TextWidth(
    ...
    return _HPDF_Page_TextWidth(page, text,)  # HPDF_Page  # c_char_p
...
def HPDF_Page_GetCurrentPos2(
    page, pos=None,  # HPDF_Page  # POINTER(HPDF_Point)
):
    pos = HPDF_Point()
    ret = _HPDF_Page_GetCurrentPos2(page, pos,)  # HPDF_Page  # POINTER(HPDF_Point)
...
def HPDF_Page_GetCurrentTextPos2(
    ...
    pos = HPDF_Point()
    ret = _HPDF_Page_GetCurrentTextPos2(page, pos,)  # HPDF_Page  # POINTER(HPDF_Point)
    return ret, pos.x, pos.y
...
def HPDF_Page_SetLineWidth(
    page, line_width,  # HPDF_Page  # HPDF_REAL
):
    line_width = HPDF_REAL(line_width)
    return _HPDF_Page_SetLineWidth(page, line_width,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_SetMiterLimit(
    page, miter_limit,  # HPDF_Page  # HPDF_REAL
):
    miter_limit = HPDF_REAL(miter_limit)
    return _HPDF_Page_SetMiterLimit(page, miter_limit,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_SetFlat(
    page, flatness,  # HPDF_Page  # HPDF_REAL
):
    flatness = HPDF_REAL(flatness)
    return _HPDF_Page_SetFlat(page, flatness,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_MoveTo(
    page, x, y,  # HPDF_Page  # HPDF_REAL  # HPDF_REAL
):
    x = HPDF_REAL(x)
    y = HPDF_REAL(y)
    return _HPDF_Page_MoveTo(page, x, y,)  # HPDF_Page  # HPDF_REAL  # HPDF_REAL
...
def HPDF_Page_LineTo(
    ...
    x = HPDF_REAL(x)
    y = HPDF_REAL(y)
    return _HPDF_Page_LineTo(page, x, y,)  # HPDF_Page  # HPDF_REAL  # HPDF_REAL
...
def HPDF_Page_Stroke(page,):  # HPDF_Page
    return _HPDF_Page_Stroke(page,)  # HPDF_Page
...
def HPDF_Page_SetCharSpace(
    ...
    value = HPDF_REAL(value)
    return _HPDF_Page_SetCharSpace(page, value,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_SetWordSpace(
    ...
    value = HPDF_REAL(value)
    return _HPDF_Page_SetWordSpace(page, value,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_SetHorizontalScalling(
    ...
    value = HPDF_REAL(value)
    return _HPDF_Page_SetHorizontalScalling(page, value,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_SetTextLeading(
    ...
    value = HPDF_REAL(value)
    return _HPDF_Page_SetTextLeading(page, value,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_SetFontAndSize(
    page, font, size,  # HPDF_Page  # HPDF_Font  # HPDF_REAL
):
    size = HPDF_REAL(size)
...
def HPDF_Page_SetTextRise(
    ...
    value = HPDF_REAL(value)
    return _HPDF_Page_SetTextRise(page, value,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_SetTextRaise(
    ...
    value = HPDF_REAL(value)
    return _HPDF_Page_SetTextRaise(page, value,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_MoveTextPos(
    ...
    x = HPDF_REAL(x)
    y = HPDF_REAL(y)
    return _HPDF_Page_MoveTextPos(page, x, y,)  # HPDF_Page  # HPDF_REAL  # HPDF_REAL
...
def HPDF_Page_MoveTextPos2(
    ...
    x = HPDF_REAL(x)
    y = HPDF_REAL(y)
    return _HPDF_Page_MoveTextPos2(page, x, y,)  # HPDF_Page  # HPDF_REAL  # HPDF_REAL
...
def HPDF_Page_ShowText(page, text):
...
def HPDF_Page_SetGrayFill(
    page, gray,  # HPDF_Page  # HPDF_REAL
):
    gray = HPDF_REAL(gray)
    return _HPDF_Page_SetGrayFill(page, gray,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_SetGrayStroke(
    ...
    gray = HPDF_REAL(gray)
    return _HPDF_Page_SetGrayStroke(page, gray,)  # HPDF_Page  # HPDF_REAL
...
def HPDF_Page_SetRGBFill(
    page, r, g, b,  # HPDF_Page  # HPDF_REAL  # HPDF_REAL  # HPDF_REAL
):
    r = HPDF_REAL(r)
    g = HPDF_REAL(g)
    b = HPDF_REAL(b)
...
def HPDF_Page_SetCMYKFill(
    page, c, m, y, k,  # HPDF_Page  # HPDF_REAL  # HPDF_REAL  # HPDF_REAL  # HPDF_REAL
):
    c = HPDF_REAL(c)
    m = HPDF_REAL(m)
    y = HPDF_REAL(y)
...
def HPDF_Page_Circle(
    page, x, y, ray,  # HPDF_Page  # HPDF_REAL  # HPDF_REAL  # HPDF_REAL
):
    x = HPDF_REAL(x)
    y = HPDF_REAL(y)
    ray = HPDF_REAL(ray)
...
def HPDF_Page_TextOut(
    page, xpos, ypos, text,  # HPDF_Page  # HPDF_REAL  # HPDF_REAL  # c_char_p
):
    xpos = HPDF_REAL(xpos)
    ypos = HPDF_REAL(ypos)
    text = bytes(text, "utf-8")
